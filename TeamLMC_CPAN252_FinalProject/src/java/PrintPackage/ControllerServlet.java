...
public class ControllerServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "/noPayOrdersList":
                    ...
                    break;
                case "/listAllNoPayClients":
                    session = request.getSession(false);
                    if (session != null) {
                        listAllNoPayClients(request, response);
                    } else {
                        response.sendRedirect("listAllNoPayClients.jsp");
                    }
                    break;
    ...
    private void listAllNoPayClients(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException, ServletException {

        List<Client> listAllNoPayClients = clientDAO.listAllNoPayClients();
        request.setAttribute("listAllNoPayClients", listAllNoPayClients);
        RequestDispatcher dispatcher = request.getRequestDispatcher("listAllNoPayClients.jsp");
        dispatcher.forward(request, response);
    }
