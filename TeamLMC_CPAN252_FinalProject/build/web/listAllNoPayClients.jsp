...
<html>
    <head>
        ...
        <title>No Payment Clients List Page</title>
    ...
    <body>
        ...
        <div class="col-sm-12" style="background-color: AliceBlue; height: 85px">
            <center>
                <h2>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a href="listAllNoPayClients" class="btn btn-info btn-lg">List All No Payment Clients</a>
                </h2>
            </center>
            <br>
        </div>
        ...
        <div class="col-sm-12">
            <table class="table table-bordered table-striped">
                <caption><h2>List of Clients that have not made Payments</h2></caption>
                <thead>
                    <tr class="info">
                        <th>ID</th>
                        <th>Agent ID</th>
                ...
                <tbody>
                    <c:forEach var="client" items="${listAllNoPayClients}">
                        <tr>
